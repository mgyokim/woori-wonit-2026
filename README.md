...
> 우리금융그룹이 운영하는 금융IT 인재양성 과정 (600시간)
> 학습 내용 정리 및 실습 기록 레포지토리

**교육기간** 2026.08.25 ~ 2026.12.11 · 평일 09:00~18:00 · 100% 오프라인
**참여 계열사** 우리금융지주 · 우리은행 · 우리카드 · 우리투자증권 · 동양생명보험 · ABL생명보험 · 우리에프아이에스 · 우리금융미래재단
**기술스택** `Java` `Spring Boot` `React` `SQL` `Docker` `AWS`
...
| 날짜 | Day | 학습 내용                        |
| --- | :---: |------------------------------|
| [08.25](./daily-log/0825.md) | Day 0 | 발대식(우리은행 본점) / 금융AX 인사이트 특강          |
